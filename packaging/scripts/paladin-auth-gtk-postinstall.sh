...
#
# paladin-auth-gtk postinstall scriptlet (.deb and .rpm).
#
...
#     /usr/share/applications/org.tamx.PaladinAuth.Gui.desktop becomes
...
#     org.tamx.PaladinAuth.Gui (referenced from both the .desktop entry
#     and the AppStream metainfo).
#
# Security posture (pinned by
# crates/paladin-auth-gtk/tests/packaging_deb_nfpm_manifest_logic.rs and
...
#     $XDG_DATA_HOME/paladin-auth/ is never created or altered by
