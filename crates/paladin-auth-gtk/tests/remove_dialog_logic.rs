...
//! Pure-logic remove-dialog tests for `paladin-auth-gtk`.
//!
...
//!
//! The module under test (`paladin_auth_gtk::remove_dialog`) is the pure-
...
use paladin_auth_core::{
    ...
    Algorithm, ErrorKind, IconHintInput, PaladinAuthError, Store, Vault, VaultInit, VaultLock,
};
...
fn save_durability_unconfirmed() -> PaladinAuthError {
...
fn seed_worker_outcome(state: &mut RemoveDialogState, err: &PaladinAuthError) {
...
fn account_not_found_error_uses_remove_operation_tag() {
    ...
    let PaladinAuthError::InvalidState { operation, state } = err else {
...
fn remove_dialog_marker_prefix_is_stable_grep_anchor() {
    ...
    assert_eq!(
        REMOVE_DIALOG_MARKER_PREFIX,
        "paladin-auth-gtk: remove_dialog_account="
    );
}
...
fn format_remove_dialog_remove_label_returns_remove() {
    ...
    // of
    // `paladin_auth_gtk::unlock_dialog::format_unlock_button_label`,
    // `paladin_auth_gtk::edit_dialog` /
    // `paladin_auth_gtk::add_account` primary-action labels on the
    // imperative-verb side; together they pin every dialog
    // footer's action affordances against a single source of
    // truth.
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_remove_label;
...
fn format_remove_dialog_cancel_label_returns_cancel() {
    ...
    // and prompts on stdin rather than rendering a dialog
    // footer, so the wording is GTK-specific. Sibling of
    // `paladin_auth_gtk::edit_dialog::format_edit_dialog_cancel_label`
    // and
    // `paladin_auth_gtk::add_account::format_add_dialog_cancel_label`
...
fn format_remove_dialog_subtitle_renders_display_label() {
    ...
    //
    // Sibling of
    // `paladin_auth_gtk::edit_dialog::format_edit_dialog_subtitle`
    ...
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_subtitle;
...
fn format_remove_dialog_icon_name_returns_user_trash_symbolic() {
    ...
    // `paladin_auth_gtk::init_dialog::format_init_dialog_icon_name`,
    // and
    // `paladin_auth_gtk::startup_error::format_startup_error_icon_name`
    // on the dialog-status-icon side; together they pin every
    // first-mount dialog's freedesktop glyph against a single
    // source of truth.
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_icon_name;
...
fn format_remove_dialog_title_returns_remove_account() {
    ...
    //
    // No TUI parity: the TUI's `remove` command is CLI-shaped
    // and prompts on stdin (see `crates/paladin-auth-tui/src/view`)
    ...
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_title;
...
fn format_remove_dialog_destructive_response_id_returns_remove() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_destructive_response_id;
...
fn format_remove_dialog_cancel_response_id_returns_cancel() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_cancel_response_id;
...
fn format_remove_dialog_inline_error_text_returns_empty_when_no_outcome() {
    ...
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_inline_error_text;
...
fn format_remove_dialog_inline_error_visible_false_when_no_outcome() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_inline_error_visible;
...
fn format_remove_dialog_inline_warning_text_returns_empty_when_no_outcome() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_inline_warning_text;
...
fn format_remove_dialog_inline_warning_visible_false_when_no_outcome() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_inline_warning_visible;
...
fn format_remove_dialog_success_toast_returns_removed() {
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_success_toast;
...
fn format_remove_dialog_destructive_response_enabled_dimmed_when_busy() {
    ...
    use paladin_auth_gtk::remove_dialog::format_remove_dialog_destructive_response_enabled;
