...
//! Auto-lock pure-logic glue for `paladin-auth-gtk`.
//!
...
//! decision through [`paladin_auth_core::policy::auto_lock::IdlePolicy`]:
//! encrypted-only gating, idle next-deadline arithmetic, and monotonic
//! expiry comparison.
//!
//! This module is the *only* place in `paladin-auth-gtk` that converts a
...
use paladin_auth_core::{Store, Vault};
...
///
/// Routes through
/// [`IdlePolicy::next_deadline`][paladin_auth_core::policy::auto_lock::IdlePolicy::next_deadline],
...
///
/// Routes through
/// [`IdlePolicy::is_expired`][paladin_auth_core::policy::auto_lock::IdlePolicy::is_expired].
...
/// [`IdlePolicy`][paladin_auth_core::policy::auto_lock::IdlePolicy]: the
/// plaintext-no-op rule and the opt-in
/// [`VaultSettings::auto_lock_enabled`][paladin_auth_core::VaultSettings::auto_lock_enabled]
...
/// [`IdlePolicy`][paladin_auth_core::policy::auto_lock::IdlePolicy]
