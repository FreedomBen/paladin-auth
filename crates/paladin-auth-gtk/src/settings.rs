...
//! Settings-dialog pure-logic state machine for `paladin-auth-gtk`.
//!
...
//! the §4.7 [`paladin_auth_core::VaultSettings`] fields as toggles and
...
//!   [`paladin_auth_core::CLIPBOARD_CLEAR_SECS_MIN`] ranges
...
//! [`paladin_auth_core::SettingPatch`] construction are the only
//! re-exposed surface, and both route through `paladin-auth-core`
...
use paladin_auth_core::{
    ErrorKind, PaladinAuthError, SettingPatch, Store, Vault, AUTO_LOCK_SECS_MAX,
...
/// editing.
///
/// Mirrors [`paladin_auth_core::VaultSettings`] field-for-field. The
/// dialog keeps a plain-data copy so the state machine can be
/// exercised in pure-logic tests without instantiating a real
/// [`paladin_auth_core::Vault`]. Construct from
/// [`paladin_auth_core::VaultSettings`] with [`CommittedSettings::from_vault_settings`].
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
impl CommittedSettings {
    ...
    /// [`paladin_auth_core::VaultSettings`].
    #[must_use]
    pub fn from_vault_settings(settings: &paladin_auth_core::VaultSettings) -> Self {
        Self {
...
pub enum DebounceOutcome {
    ...
    Save {
        ...
        /// [`paladin_auth_core::Vault::apply_setting_patch`].
        patch: SettingPatch,
...
/// `crates/paladin-auth-tui/src/view`), so the wording is
/// GTK-specific.
///
...
/// [`paladin_auth_core::VaultSettings::auto_lock_enabled`] and
/// `AdwSpinRow` for the timeout
/// [`paladin_auth_core::VaultSettings::auto_lock_secs`].
///
...
/// [`paladin_auth_core::VaultSettings::auto_lock_secs`], clamps to
/// [`paladin_auth_core::AUTO_LOCK_SECS_MIN`]
/// ..= [`paladin_auth_core::AUTO_LOCK_SECS_MAX`] via
...
/// "Preferences" and §"Component tree" > `SettingsComponent`.
/// The spinner controls
/// [`paladin_auth_core::VaultSettings::clipboard_clear_secs`], clamps
/// to [`paladin_auth_core::CLIPBOARD_CLEAR_SECS_MIN`]
/// ..= [`paladin_auth_core::CLIPBOARD_CLEAR_SECS_MAX`] via
...
///
/// Returns
/// `(f64::from(paladin_auth_core::AUTO_LOCK_SECS_MIN), f64::from(paladin_auth_core::AUTO_LOCK_SECS_MAX), 1.0)`
...
pub fn format_settings_dialog_auto_lock_secs_adjustment() -> (f64, f64, f64) {
    (
        f64::from(paladin_auth_core::AUTO_LOCK_SECS_MIN),
        f64::from(paladin_auth_core::AUTO_LOCK_SECS_MAX),
        1.0,
    )
}
...
///
/// Returns
/// `(f64::from(paladin_auth_core::CLIPBOARD_CLEAR_SECS_MIN), f64::from(paladin_auth_core::CLIPBOARD_CLEAR_SECS_MAX), 1.0)`
...
pub fn format_settings_dialog_clipboard_clear_secs_adjustment() -> (f64, f64, f64) {
    (
        f64::from(paladin_auth_core::CLIPBOARD_CLEAR_SECS_MIN),
        f64::from(paladin_auth_core::CLIPBOARD_CLEAR_SECS_MAX),
        1.0,
    )
}
...
/// `crates/paladin-auth-tui/src/view`), so the wording is GTK-specific.
///
/// Pure — returns a `'static str` without allocating.
#[must_use]
...
/// by [`paladin_auth_core::Vault::apply_setting_patch`] inside
...
/// ([`paladin_auth_core::VaultSettings::auto_lock_timeout_secs`] and
/// [`paladin_auth_core::VaultSettings::clipboard_clear_secs`]) are
...
///
/// The dialog opens on a snapshot of the current `paladin_auth_core::VaultSettings`
