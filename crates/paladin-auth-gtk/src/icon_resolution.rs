...
//! Account-row icon resolution for `paladin-auth-gtk`.
//!
...
///   (already validated by `paladin_auth_core::validate_slug` /
///   `paladin_auth_core::parse_icon_hint_token` on the add path).
