...
//! Help-overlay reducer tests for `paladin-auth-tui`.
//!
...
//! [`paladin_auth_tui::app::state::AppState::Unlocked`]; `?` opens it from
...
use paladin_auth_tui::app::state::{AppState, Focus, Modal, SettingsModal};
...
fn ctrl_c_still_quits_while_help_is_open() {
    ...
    use paladin_auth_tui::app::event::Effect;
