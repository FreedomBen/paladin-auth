...
//! Input thread tests for `paladin-auth-tui`.
//!
...
//! callers invoke [`paladin_auth_tui::app::input::spawn`] which threads the
//! real reader in. The tests drive
//! [`paladin_auth_tui::app::input::spawn_with`] with a fake reader fed off
...
use paladin_auth_tui::app::input;
