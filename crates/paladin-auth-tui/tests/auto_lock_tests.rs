...
//! Auto-lock idle-deadline and lock-transition tests for `paladin-auth-tui`.
//!
...
use paladin_auth_tui::app::event::{AppEvent, Effect};
...
// `paladin_auth_core::IdlePolicy::next_deadline(at, is_encrypted, settings)`,
...
//
// On each `paladin_auth_core::TICK_INTERVAL_MS` `Tick` the reducer asks
