...
//! Dispatch-loop tests for `paladin-auth-tui`.
//!
...
//!
//! [`paladin_auth_tui::app::dispatch::dispatch`] is the pure event-loop
...
//! returns [`paladin_auth_tui::app::EffectOutcome::Quit`] or the producer
...
use paladin_auth_tui::app::dispatch::dispatch;
