...
//! Tests for the `paladin_auth_tui::app::render::draw_frame` adapter that
...
//! buffer produced by [`paladin_auth_tui::app::render::draw_frame`] matches,
...
use paladin_auth_core::{
    ...
    IconHintInput, PaladinAuthError, PermissionSubject, Store, VaultInit,
};
use paladin_auth_tui::app::render::draw_frame;
use paladin_auth_tui::app::state::{decide_state_from_open, AppState};
...
/// the `paladin_auth_tui::cli::should_disable_color` wiring; the
