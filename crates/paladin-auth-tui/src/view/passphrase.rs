...
//! is gated by [`Vault::is_encrypted()`](paladin_auth_core::Vault::is_encrypted):
...
/// [`paladin_auth_core::format_plaintext_storage_warning`], a flexible
...
/// `paladin-auth passphrase set / change / remove` command help.
