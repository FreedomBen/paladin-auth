...
//! the TUI shows a single-screen list view — a bordered `Paladin Auth`
...
//! (per [`paladin_auth_core::account_matches_search`]'s "empty needle
...
use paladin_auth_core::{AccountId, AccountKindSummary, AccountSummary, Code, Vault};
...
/// Build the bordered block's title line. The base " Paladin Auth "
