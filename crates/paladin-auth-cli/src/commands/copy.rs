...
//! `paladin-auth copy <query>` — copy the current code to the clipboard via
...
use paladin_auth_core::{AccountId, AccountKindSummary, AccountSummary, PaladinAuthError, Vault};
