...
//! `paladin-auth rename <query> <new-label>` — rename an account. See
...
//!    [`paladin_auth_core::Vault::rename`] which performs label validation
...
use paladin_auth_core::{AccountId, AccountSummary, PaladinAuthError, Vault};
