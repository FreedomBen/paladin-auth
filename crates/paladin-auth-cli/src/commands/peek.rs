...
//! `paladin-auth peek <query>` — print the current code without advancing
...
//! 2. Resolve the query through `paladin_auth_core::parse_account_query` /
...
use paladin_auth_core::{
    AccountId, AccountKindSummary, AccountSummary, Code, PaladinAuthError, Vault,
};
