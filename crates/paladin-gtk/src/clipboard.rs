...
//! [`paladin_core::ClipboardClearPolicy`] (via the pure-logic
//! [`crate::clipboard_clear`] module):
//!
//! * Opt-in gate and monotonic token issuance live on
//!   [`paladin_core::ClipboardClearPolicy::schedule`] (re-exported by
//!   [`crate::clipboard_clear::schedule_copy`]).
//! * The only-if-unchanged byte-equality decision lives on
//!   [`paladin_core::ClipboardClearPolicy::should_clear`] (re-exported
...
//!
//! This module is the only place in `paladin-gtk` that touches the
...
//! and that rule lives in [`paladin_core::policy::auto_lock::IdlePolicy`]).
//!
...
/// [`paladin_core::ClipboardClearPolicy::should_clear`] byte-equality
/// check expects.
///
...
/// [`paladin_core::ClipboardClearPolicy::should_clear`] /
