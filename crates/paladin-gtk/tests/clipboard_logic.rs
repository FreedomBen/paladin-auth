...
//! Pure-logic tests for [`paladin_gtk::clipboard`].
//!
...
//! [`paladin_core::ClipboardClearPolicy`] (which speaks bytes) and the
...
//!   [`paladin_gtk::clipboard_clear::evaluate_wake`] resolves to
//!   `Mismatch` in those cases.

use zeroize::Zeroizing;

use paladin_gtk::clipboard::{captured_clipboard_bytes, payload_text};
