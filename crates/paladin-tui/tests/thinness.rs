...
// here — they belong in `paladin-core`. This test scans the production
...
#[test]
fn paladin_tui_source_tree_does_not_reference_forbidden_crates() {
    ...
    assert!(
        hits.is_empty(),
        "paladin-tui/src/ contains forbidden crate references — move the \
...
#[test]
fn paladin_tui_manifest_does_not_declare_forbidden_dependency() {
    ...
    assert!(
        hits.is_empty(),
        "paladin-tui/Cargo.toml declares forbidden direct dependencies — \
