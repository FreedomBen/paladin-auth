...
fn destroy_state(modal: DestroyModal) -> AppState {
    AppState::Destroy {
        path: PathBuf::from("/home/u/.local/share/paladin/vault.bin"),
...
fn warning_with_backup() -> String {
    paladin_core::format_destroy_warning(
        std::path::Path::new("/home/u/.local/share/paladin/vault.bin"),
        true,
    )
}
...
fn snapshot_unlock_footer_hint() {
    ...
    let state = AppState::Unlock {
        path: PathBuf::from("/home/u/.local/share/paladin/vault.bin"),
        error: None,
        passphrase: paladin_tui::prompt::PassphraseBuffer::new(),
    };
...
fn snapshot_startup_error_footer_hint() {
    ...
    let state = AppState::StartupError {
        path: Some(PathBuf::from("/home/u/.local/share/paladin/vault.bin")),
