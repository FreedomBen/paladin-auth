...
//
// Domain model for Paladin Auth (docs/DESIGN.md §4.1, §4.7).
//
...
impl IconHintInput {
    pub(crate) fn resolve(
        self,
        issuer: Option<&str>,
    ) -> Result<Option<String>, crate::error::PaladinAuthError> {
        match self {
...
impl Account {
    ...
    pub(crate) fn touch(&mut self, now: SystemTime) -> Result<(), crate::error::PaladinAuthError> {
