...
pub fn qr_png(account: &Account, opts: &QrRenderOptions) -> Result<Zeroizing<Vec<u8>>> {
    ...
    image
        ...
        .map_err(|_| PaladinAuthError::validation("qr_render", "png_encode_failed"))?;
...
fn qr_render_err(err: qrcode::types::QrError) -> PaladinAuthError {
    ...
    PaladinAuthError::validation("qr_render", reason)
}
