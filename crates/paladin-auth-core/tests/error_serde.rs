...
use paladin_auth_core::{
    ...
    ImportReport, ImportWarning, PaladinAuthError, PermissionSubject, TimeRangeKind,
    ValidationWarning, VaultMode, VaultSettings,
};
use serde_json::json;
...
#[test]
fn paladin_auth_error_validation_envelope_skips_none_options() {
...
#[test]
fn paladin_auth_error_unit_variants_carry_only_kind() {
    for (err, expected_kind) in [
        (PaladinAuthError::VaultMissing, "vault_missing"),
        (PaladinAuthError::VaultExists, "vault_exists"),
        (PaladinAuthError::DecryptFailed, "decrypt_failed"),
        (PaladinAuthError::InvalidHeader, "invalid_header"),
        (
        ...
        (PaladinAuthError::NoEntriesToImport, "no_entries_to_import"),
        (
        ...
        assert_eq!(
            ...
            "PaladinAuthError::{err:?}"
        );
    }
}

#[test]
fn paladin_auth_error_unsafe_permissions_envelope() {
    let err = PaladinAuthError::UnsafePermissions {
        path: PathBuf::from("/home/u/.local/share/paladin-auth"),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "path": "/home/u/.local/share/paladin-auth",
            "subject": "vault_dir",
            "actual_mode": "0755",
            "expected_mode": "0700",
        })
...
#[test]
fn paladin_auth_error_wrong_vault_lock_envelope() {
...
#[test]
fn paladin_auth_error_kdf_params_out_of_bounds_envelope() {
...
#[test]
fn paladin_auth_error_save_not_committed_includes_optional_backup_path() {
    let no_backup = PaladinAuthError::SaveNotCommitted {
        committed: false,
        backup_path: None,
    };
    assert_eq!(
    ...
    let with_backup = PaladinAuthError::SaveNotCommitted {
        committed: false,
...
#[test]
fn paladin_auth_error_io_error_skips_underlying_source() {
...
#[test]
fn paladin_auth_error_destroy_io_error_carries_partial_state_envelope() {
...
#[test]
fn paladin_auth_error_counter_overflow_includes_account_summary() {
    let summary = fixture_summary();
    let err = PaladinAuthError::CounterOverflow {
...
/// One representative `PaladinAuthError` value per variant. Used by the
...
#[test]
fn paladin_auth_error_kind_round_trips_through_serialize_for_every_variant() {
