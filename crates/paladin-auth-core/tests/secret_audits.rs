...
const PASSPHRASE_CANARY: &str = "PaladinAuthAuditCanaryPassphrase-DoNotLeak-9876543210";
...
assert_not_impl_all!(paladin_auth_core::Secret: std::fmt::Debug);
assert_not_impl_all!(paladin_auth_core::AccountInput: std::fmt::Debug);
assert_not_impl_all!(paladin_auth_core::Secret: serde::Serialize);
assert_not_impl_all!(paladin_auth_core::Account: serde::Serialize);
