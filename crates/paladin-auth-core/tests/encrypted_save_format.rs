...
fn encrypted_save_writes_exact_64_byte_header_then_ciphertext() {
    ...
    assert_eq!(&bytes[0..8], b"PALAUTH\0", "magic at bytes 0..8");
...
fn encrypted_save_empty_vault_ciphertext_is_exactly_tag_length() {
    ...
    paladin_auth_core::zeroize_witness::clear_observations();
    ...
    #[cfg(feature = "test-zeroize-witness")]
    {
        use paladin_auth_core::zeroize_witness::{take_observations, WitnessSite};
